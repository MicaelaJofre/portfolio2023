...
const PortfolioIcon = ({ color, width, height }: IconProps) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill={color} className="octicon octicon-file-directory" viewBox="0 0 16 16">
      <path
        fillRule="evenodd"
